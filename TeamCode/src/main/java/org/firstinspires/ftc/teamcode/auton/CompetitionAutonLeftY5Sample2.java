 ...
 */
@Config
@Autonomous (name = "Competition Auton Left 5 Sample 2" , group = "Autonomous")
public class CompetitionAutonLeftY5Sample2 extends OpMode {
...
//////////////////////// after 3rd dump
           ...
           /////////////////////////
            case 79: // to basket
                robot.transferPos();
                pausetime.reset();
                follower.followPath(autonp.move9a);
                setPathState(80);
                break;
            case 80: //
                follower.update();
         ...
         /*           if (robot.liftL.getCurrentPosition() < robot.LIFTBASKET) {
           ...
           */     }
                ...
                break;
            case 82: // to basket
                follower.followPath(autonp.move9b);
                setPathState(84);
                break;
            case 84: //
                follower.update();
