...
public class AutonPaths1B {
    ...
    public static Path move2, move2a, move2b, move2c, move2d, move2b2, move2t;
    ...
    public AutonPaths1B(OpMode opmode) {
        myOpMode = opmode;
    }
  ...
  //      move2a.setConstantHeadingInterpolation(Math.toRadians(90));
        ...
        move2b = new Path(new BezierCurve(
                new Point(30, 86, Point.CARTESIAN),
                new Point(30,107, Point.CARTESIAN)));
        move2b.setConstantHeadingInterpolation(Math.toRadians(90));

        move2c = new Path(new BezierCurve(
                new Point(30, 107, Point.CARTESIAN),
                new Point(45,106, Point.CARTESIAN)));
        move2c.setConstantHeadingInterpolation(Math.toRadians(90));

        move2d = new Path(new BezierCurve(
                new Point(45, 106, Point.CARTESIAN),
                new Point(45,105, Point.CARTESIAN)));
        move2d.setConstantHeadingInterpolation(Math.toRadians(90));
    ...
    //    move2b.setConstantHeadingInterpolation(Math.toRadians(90));
        ...
        move3 = new Path(new BezierLine(
                new Point(45,105, Point.CARTESIAN),
                new Point(45,108, Point.CARTESIAN)));
        ...
        move4.setConstantHeadingInterpolation(Math.toRadians(90));  // to 2nd neutral specimen
