...
public class FollowerConstants {
    ...
    public static String leftFrontMotorName = "wheel4";
    public static String leftRearMotorName = "wheel3";
    public static String rightFrontMotorName = "wheel1";
    public static String rightRearMotorName = "wheel2";

    // This section is for setting the actual drive vector for the front left wheel, if the robot
    // is facing a heading of 0 radians with the wheel centered at (0,0)
    private static double xMovement = 58;
