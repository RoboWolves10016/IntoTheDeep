...
import org.firstinspires.ftc.teamcode.auton.paths.AutonPathsRight4H;
 ...
 */
@Config
@Autonomous (name = "Competition Auton Right 4 Specimen" , group = "Autonomous")
public class CompetitionAutonRight4Specimen extends OpMode {
    AutonPathsRight4H autonp = new AutonPathsRight4H(this);
    ...
    static final double JIGGLE_DEGREES = 3, JIGGLE_TIME = 0.01;
...
// push 2 samples into the zone
            ...
            case 20:
                follower.update();
                robot.liftWall();
                if (follower.getCurrentPathNumber() == 5)  {
                    pausetime.reset();
                    follower.setMaxPower(0.4);
                }
                if (follower.getCurrentPathNumber() == 6)  {
                    follower.setMaxPower(0.25);
                    if (pausetime.seconds() > 1) pausetime.reset();
                }
